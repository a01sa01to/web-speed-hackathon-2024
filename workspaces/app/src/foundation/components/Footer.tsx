...
export const Footer: React.FC = () => {
  ...
  const handleRequestToTermDialogOpen = async () => {
    const TERM = await fetch('/assets/constants/term.txt').then((res) => res.text());
  ...
  const handleRequestToContactDialogOpen = async () => {
    const CONTACT = await fetch('/assets/constants/contact.txt').then((res) => res.text());
  ...
  const handleRequestToQuestionDialogOpen = async () => {
    const QUESTION = await fetch('/assets/constants/question.txt').then((res) => res.text());
  ...
  const handleRequestToCompanyDialogOpen = async () => {
    const COMPANY = await fetch('/assets/constants/company.txt').then((res) => res.text());
  ...
  const handleRequestToOverviewDialogOpen = async () => {
    const OVERVIEW = await fetch('/assets/constants/overview.txt').then((res) => res.text());
